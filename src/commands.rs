...
pub(crate) async fn file_reader_open<R: Runtime>(
    ...
    app.android_mediastore().file_reader_open(payload)
}
...
pub(crate) async fn file_reader_read<R: Runtime>(
    ...
    app.android_mediastore().file_reader_read(payload)
}
...
pub(crate) async fn file_reader_close<R: Runtime>(
    ...
    app.android_mediastore().file_reader_close(payload)
}
...
pub(crate) async fn file_reader_seek<R: Runtime>(
    ...
    app.android_mediastore().file_reader_seek(payload)
}
...
pub(crate) async fn file_reader_read_to_end<R: Runtime>(
    ...
    app.android_mediastore().file_reader_read_to_end(payload)
}
...
pub(crate) async fn file_reader_info<R: Runtime>(
    ...
    app.android_mediastore().file_reader_info(payload)
}
